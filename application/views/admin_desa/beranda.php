		...
		<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<li>
							<a href="<?php echo site_url('admin_desa//kelola_penduduk');?>" target="iframe">
							<i class="glyphicon glyphicon-user"></i>
							  Kelola Penduduk</a>
						</li>
						<li>
							<a href="<?php echo site_url('admin_desa//kelola_pimpinan');?>" target="iframe">
							<i class="glyphicon glyphicon-cog"></i>
								Setting Data Pimpinan
							</a>
						</li>
						<li>
							<a href="<?php echo site_url('admin_desa//artikel');?>" target="iframe">
...
<div class="container-fluid">
	...
	<div class="col-md-12">
		...
		<iframe name="iframe" frameborder="0" height="150%" width="100%" src="<?php echo site_url('admin_desa/beranda/status');?>"></iframe>
	</div>
	</div>
</div>
</body>
